...
export async function handleLanguagesCommand(): Promise<void> {
  try {
    ...
    console.log('\nUsage examples:');
    console.log(chalk.cyan('ct translate zh-TW') + ' - Translate clipboard content to Traditional Chinese');
    console.log(chalk.cyan('ct translate en-US -f zh-TW') + ' - Translate Traditional Chinese text to American English\n');
  } catch (error) {
